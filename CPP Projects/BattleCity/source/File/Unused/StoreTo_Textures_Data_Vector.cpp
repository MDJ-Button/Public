...
bool File::StoreTo_Textures_Data_Vector(std::string _line)
{
    Game game;
    game.Print(false, true, game.Func_Open("File", "StoreTo_Textures_Data_Vector"));
    ...
    game.Print(false, true, game.Func_Close("File", "StoreTo_Textures_Data_Vector"));
